...
export default class RevertTimesheetsInIntime extends LightningElement {
    // PRIVATE ATTRIBUTES 
    _timesheetsList;
    ...
    **/
    handleSave (event) {
        ...
        saveRecords({
            ...
            if (result && result.hasOwnProperty('apexJobId') && result.apexJobId) {
