...
export default class ShiftManagementAdjustmentFilters extends LightningElement {
    ...
    **/
    handleReset() {
        ...
        this.template.querySelector('[data-id="chargeRate"]').value = '';
        this.template.querySelector('[data-id="payRate"]').value = '';
        this.dispatchEvent(new CustomEvent('timesheetsearch',{ 
            detail: {
                ...
                'chargeRate' : this.template.querySelector('[data-id="chargeRate"]').value,
                'payRate' : this.template.querySelector('[data-id="payRate"]').value
            }
        }));
    }
