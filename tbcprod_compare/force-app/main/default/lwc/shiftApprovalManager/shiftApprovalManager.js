...
export default class ShiftApprovalManager extends NavigationMixin(LightningElement) {
    ...
    get approvedFilters() {
        return [
            ...
            { label: 'Approved Shifts - Not Payrolled', value: 'Approved Shifts - Not Payrolled' },
            { label: 'Approved Shifts - Payrolled', value: 'Approved Shifts - Payrolled' },
    ...
    get _SHOW_PROCESS_PAY() {
        return this._CAN_APPROVE_CHARGE && this._CAN_APPROVE_PAY;        
    }
    get _CAN_SUBMIT_ALL() {
